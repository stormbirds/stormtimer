...
public class HashedWheelTimer implements Timer {
    ...
    static final Logger logger = JdkLoggerFactory.newInstance("stormtimer.HashedWheelTimer");
    ...
    public HashedWheelTimer(
        ...
        if (duration < MILLISECOND_NANOS) {
            logger.log(Level.WARNING, String.format("Configured tickDuration %d smaller then %d, using 1ms.",
    ...
    private static void reportTooManyInstances() {
        if (logger.getLevel().getName().equals(Level.SEVERE.getName())) {
            String resourceType = simpleClassName(HashedWheelTimer.class);
            error("You are creating too many " + resourceType + " instances. " +
        ...
        private void processCancelledTasks() {
            for (;;) {
                ...
                try {
                    ...
                    if (logger.getLevel().getName().equals(Level.WARNING.getName())) {
                        warn("An exception was thrown while process a cancellation task", t);
                    }
                }
            }
        }
    ...
    private static final class HashedWheelTimeout implements Timeout {
        ...
        public void expire() {
            ...
            try {
                ...
                if (logger.getLevel().getName().equals(Level.WARNING.getName())) {
                    warn("An exception was thrown by " + TimerTask.class.getSimpleName() + '.', t);
                }
            }
        }
