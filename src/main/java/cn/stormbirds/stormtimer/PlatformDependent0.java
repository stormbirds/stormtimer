...
import static cn.stormbirds.stormtimer.ObjectUtil.checkNotNull;
import static cn.stormbirds.stormtimer.ObjectUtil.checkPositiveOrZero;

/**
 *
 * <p> PlatformDependent0.java
 * </p>
...
final class PlatformDependent0 {
    ...
    private static final Logger logger = JdkLoggerFactory.newInstance("PlatformDependent0");
    ...
    static {
        ...
        if ((unsafeUnavailabilityCause = EXPLICIT_NO_UNSAFE_CAUSE) != null) {
            ...
            if (maybeUnsafe instanceof Throwable) {
                ...
                debug("sun.misc.Unsafe.theUnsafe: unavailable", (Throwable) maybeUnsafe);
            } else {
            ...
            if (unsafe != null) {
                ...
                if (maybeException == null) {
                    ...
                    debug("sun.misc.Unsafe.copyMemory: unavailable", (Throwable) maybeException);
                }
            }
            ...
            if (unsafe != null) {
                ...
                if (maybeAddressField instanceof Field) {
                    ...
                    debug("java.nio.Buffer.address: unavailable", (Throwable) maybeAddressField);
            ...
            if (unsafe != null) {
                ...
                if (byteArrayIndexScale != 1) {
                    debug("unsafe.arrayIndexScale is {} (expected: 1). Not using unsafe.", byteArrayIndexScale);
        ...
        if (unsafe == null) {
            ...
            if (maybeUnaligned instanceof Boolean) {
                ...
                debug("java.nio.Bits.unaligned: available, {}", unaligned);
            } else {
                String arch = SystemPropertyUtil.get("os.arch", "");
                //noinspection DynamicRegexReplaceableByCompiledPattern
                unaligned = arch.matches("^(i[3-6]86|x86(_64)?|x64|amd64)$");
                Throwable t = (Throwable) maybeUnaligned;
                debug("java.nio.Bits.unaligned: unavailable {}", unaligned, t);
            }
            ...
            if (javaVersion() >= 9) {
                ...
                if (maybeException instanceof Throwable) {
                    ...
                    debug("jdk.internal.misc.Unsafe.allocateUninitializedArray(int): available");
                }
            } else {
        ...
        debug("java.nio.DirectByteBuffer.<init>(long, int): {}",
    ...
    private static Throwable explicitNoUnsafeCause0() {
        ...
        debug("-Dio.netty.noUnsafe: {}", noUnsafe);

        if (noUnsafe) {
            debug("sun.misc.Unsafe: unavailable (io.netty.noUnsafe)");
    ...
    static ByteBuffer newDirectBuffer(long address, int capacity) {
        checkPositiveOrZero(capacity, "capacity");
    ...
    private static int javaVersion0() {
        ...
        debug("Java version: {}", majorVersion);
