...
import static cn.stormbirds.stormtimer.StringUtil.simpleClassName;

/**
 *
 * <p> ResourceLeakDetector.java
 * </p>
...
public class ResourceLeakDetector<T> {
    ...
    private static final String NEWLINE = SystemPropertyUtil.get("line.separator", "\n");
    ...
    private static final Logger logger = JdkLoggerFactory.newInstance("ResourceLeakDetector");

    static {
        final boolean disabled;
        if (SystemPropertyUtil.get("io.netty.noResourceLeakDetection") != null) {
            disabled = SystemPropertyUtil.getBoolean("io.netty.noResourceLeakDetection", false);
            debug("-Dio.netty.noResourceLeakDetection: {}", disabled);
            warn("-Dio.netty.noResourceLeakDetection is deprecated. Use '-D{}={}' instead.",
        ...
        debug("-D{}: {}", PROP_LEVEL, level.name().toLowerCase());
        debug("-D{}: {}", PROP_TARGET_RECORDS, TARGET_RECORDS);
    ...
    private void reportLeak() {
        if (!logger.getLevel().getName().equals(java.util.logging.Level.SEVERE.getName())) {
            clearRefQueue();
            return;
        }
    ...
    private static final AtomicReference<String[]> excludedMethods =
            new AtomicReference<String[]>(new String[]{});
    ...
    private static void debug(String msg, Object obj){
        logger.log(java.util.logging.Level.CONFIG,msg,obj);
    }
    private static void debug(String msg,Object obj, Object throwable){
        logger.log(java.util.logging.Level.CONFIG, String.format(msg,obj) ,throwable);
    }

    private static void error(String msg, String obj, String obj2){
        logger.log(java.util.logging.Level.SEVERE, String.format(msg,obj,obj2) );
    }
    private static void error(String... msg){
        logger.log(java.util.logging.Level.SEVERE,"",msg);
    }
    private static void warn(String msg,String... msg1){
        logger.log(java.util.logging.Level.WARNING, msg,msg1);
    }
